...
alter table SolutionFolders add InterfaceNamespaceFormat nvarchar(300) 

--delete SolutionsDBTables
...
--delete SolutionsDBTableColumns
...
--delete SolutionsDBQueryColumns
...
Alter Table Projects add BusinessEntity_ProjectId int default(0)
...
Alter Table ProjectFiles add TableName nvarchar(200) ;
